...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi The website is under construction and maintenance, please wait',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'balanceboard.top', // 您的昵称 例如 tangly1024
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'balanceboard', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'Toibenaonline@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'balanceboard.top', // 你的twitter个人主页
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'balanceboard.top', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
