...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: 'High Power Battery Spot Welder，Pulse spot welding machine handheld small', // 英雄区文字
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/hero/1.jpg', // 产品预览图 ，默认读取public目录下图片
  ...
  STARTER_FEATURE_1_TEXT_1: 'Experience unparalleled precision with our 0-199 adjustable settings, ensuring perfect welds every time', // 特性1
  STARTER_FEATURE_1_BUTTON_TEXT: 'learn more', // 特性1
  STARTER_FEATURE_1_BUTTON_URL: 'https://github.com/tangly1024/NotionNext', // 特性1

  STARTER_FEATURE_2_TITLE_1: 'Versatile Power Options', // 特性2
  STARTER_FEATURE_2_TEXT_1: 'Effortlessly power your welding projects with a 9-12V supply, including car batteries (12V, 20Ah+) or innovative 4-6 series supercapacitors (9-11V)', // 特性2
  ...
  STARTER_FEATURE_3_TEXT_1: 'Switch between single and double pulse settings for ultimate control over your welds.', // 特性3
  ...
  STARTER_FEATURE_4_TEXT_1: 'Take your welding on the go with our support for standalone 12V power or connect to 2 series supercapacitors', // 特性4
  ...
  STARTER_FOOTER_PRIVACY_POLICY_TEXT: 'After-sales policy',
  ...
  // 404页面的提示语
  STARTER_404_TITLE: 'We cannot find the page you are looking for。',
